---
summary: "Use SOUL.md to give your agent an actual voice instead of generic assistant sludge"
read_when:
...
Hermes injects it on normal sessions, so it has real weight. If your agent
...
For Hermes, `SOUL.md` is that layer.
...
Path fixed for Hermes workspaces: use `SOUL.md`, not `http://SOUL.md`.
